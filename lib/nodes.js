...
Nodes.prototype = {
  ...
  'aggregateLocation': function(doc){
    ...
    this.aggregator.data.InteractionMap.locationIndex = this.locationMap[doc.location];
    ...
    console.log(this.aggregator.data.InteractionMap)
  },
  'Glow Bar': function(doc){
    this.aggregateZone('Drinking', doc.userId);
  },
  'Catering': function(doc){
    this.aggregateZone('Catering', doc.userId);
  },
  'S Bar': function(doc){
    this.aggregateZone('Drinking', doc.userId);
  },
